...
class LeggiMiScanPackage : ReactPackage {
    override fun createNativeModules(reactContext: ReactApplicationContext): List<NativeModule> =
        listOf(LeggiMiScanModule(reactContext), LeggiMiCloudModule(reactContext), LeggiMiPlaybackModule(reactContext), LeggiMiPiperModule(reactContext), LeggiMiLiveModule(reactContext))
